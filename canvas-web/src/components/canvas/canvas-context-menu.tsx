                ...
                <div className="thin-scrollbar min-h-0 overflow-y-auto">
                    {menu.type === "node" && isMedia && categoryOpen ? (
                        ...
                        <>
                            ...
                            {!isProjectLinked ? <MenuButton icon={<FolderOpen className="size-4" />} label="从资产库插入" onClick={() => runAction(onOpenAssets)} /> : null}
                            <MenuDivider />
                        ...
                        <>
                            {isCharacterReference ? (
                                ...
                                <>
                                    ...
                                    {isImage ? <MenuButton icon={<CloudUpload />} label="上传到方舟资产库" onClick={() => runAction(onUploadToArkPrivateAsset)} /> : null}
                                    <MenuDivider />
                                    <MenuSection label="节点" />
