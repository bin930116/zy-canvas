...
export const nodeHoverToolbarTools: ToolDefinition[] = [
    ...
    },
    {
        ...
        defaultVisible: true,
        defaultOrder: 40,
        nodeToolbar: { group: "process", order: 10, section: "提取资产", description: "选取画面，保存为图片节点" },
    ...
    },
    {
        ...
        defaultVisible: true,
        defaultOrder: 42,
        nodeToolbar: { group: "process", order: 20, section: "提取资产", description: "生成音频节点，保留原视频声音" },
        applicable: (ctx) => hasVideo(ctx) && !simpleMode(ctx),
    ...
    },
    {
        ...
        defaultVisible: true,
        defaultOrder: 50,
        nodeToolbar: { group: "more", order: 40, section: "资产" },
    ...
    },
    {
        ...
        defaultVisible: true,
        defaultOrder: 140,
        nodeToolbar: { group: (ctx) => hasVideo(ctx) ? "more" : "primary", order: 45, section: "资产" },
        applicable: isVideo,
        run: (ctx) => ctx.handlers.onNodeUpload(ctx.node!),
    },
    {
    ...
    },
    {
        ...
        defaultVisible: true,
        defaultOrder: 148,
        nodeToolbar: { group: "workspace", order: 30, section: "项目剪辑", description: "打开项目时间线，定位到当前资产" },
    ...
    },
    {
        ...
        defaultVisible: true,
        defaultOrder: 150,
        nodeToolbar: { group: (ctx) => hasAudio(ctx) ? "more" : "primary", order: 45, section: "资产" },
        applicable: isAudio,
        run: (ctx) => ctx.handlers.onNodeUpload(ctx.node!),
    },
    // 节点锁定——独立分类，自动插入前置分隔符
