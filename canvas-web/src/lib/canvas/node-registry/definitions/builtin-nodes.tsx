...
const BUILTIN_NODE_TRAITS = {
    ...
    [CanvasNodeType.Config]: {
        ...
        // 不设 inputKind：配置节点本身不是参考资产，不参与容量计数。
    },
    ...
    [CanvasNodeType.Svg]: {
        ...
        minSize: DEFAULT_MIN_SIZE,
        showInCreateMenu: true,
        // 内容是 SVG 源码，按文本资产计；渲染成图但不产出图片资源。
        resourceKind: (node: CanvasNodeData) => (node.metadata?.content ? "text" : null),
        inputKind: "text",
    },
    [CanvasNodeType.Html]: {
    ...
    [CanvasNodeType.Panorama]: {
        ...
        minSize: MEDIA_NODE_MIN_SIZE,
        showInCreateMenu: true,
        // 查看器：消费上游图片，自身不作为资产被引用，故不设 resourceKind。
        inputKind: "image",
    },
