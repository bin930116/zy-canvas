...
export function normalizePublicAppearance(value?: Partial<PublicAppearance> | null): PublicAppearance {
    ...
    return {
        ...
        icpFilingNumber,
        logoConfigured: value?.logoConfigured !== false,
        darkLogoConfigured: value?.darkLogoConfigured !== false,
...
export function brandStudioLabel(appearance: PublicAppearance) {
    if (appearance.brandName === DEFAULT_PUBLIC_APPEARANCE.brandName && appearance.brandSlug === DEFAULT_PUBLIC_APPEARANCE.brandSlug) return "ARCHERMIND";
