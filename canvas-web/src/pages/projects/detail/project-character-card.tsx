...
import { assetSourceLabel, textValue } from "./shared";
    ...
    return (
        <AssetLibraryCard className="project-character-card">
            ...
            <div className="p-3">
                ...
                <span className="mt-1 inline-block rounded bg-foreground/[.06] px-1.5 py-0.5 text-[var(--fs-micro)] text-foreground/45">{assetSourceLabel(asset.source)}</span>
