...
import { getAuthSession, register, sendRegistrationEmailCode } from "@/services/api/auth";
...
export default function RegisterPage() {
    ...
    return (
        <form onSubmit={submit} className="space-y-4">
            ...
            <AuthField label="邮箱"><Input size="large" prefix={<Mail className="size-4 text-white/35" />} value={email} onChange={(event) => setEmail(event.target.value)} placeholder="用于登录与安全验证" autoComplete="email" disabled={disabled} /></AuthField>
