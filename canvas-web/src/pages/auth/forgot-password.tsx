...
import { resetPassword, sendPasswordResetEmailCode } from "@/services/api/auth";
    ...
    if (stage === "request") {
        return (
            <form onSubmit={requestCode} className="space-y-5">
                {false ? <Notice icon={<TriangleAlert className="size-3.5" />}>管理员尚未启用密码找回，请联系管理员处理。</Notice> : null}
                ...
                <Button type="primary" htmlType="submit" size="large" block loading={sendingCode} disabled={false} icon={<ArrowRight className="size-4" />} iconPlacement="end">
                    发送验证码
                </Button>
