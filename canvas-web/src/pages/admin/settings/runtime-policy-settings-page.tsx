...
const resourceFields: PolicyField[] = [
    { group: "resource", name: "resourceUploadMB", label: "普通资源单文件", extra: "资产上传和远程导入的单文件业务上限。", unit: "MB", max: 999 },
    ...
    { group: "resource", name: "structuredDataMB", label: "结构化数据总量", extra: "画布、资产和 Agent 会话结构化数据合计。", unit: "MB", max: 999_999 },
    { group: "resource", name: "taskDataGB", label: "任务数据总量", extra: "任务历史、结果和上游请求日志合计。", unit: "GB", max: 999 },
    { group: "resource", name: "assetCount", label: "资产数量", extra: "单账号可保存的资产记录数。", unit: "条", max: 999_999_999 },
    ...
    { group: "resource", name: "recycleBinRetentionDays", label: "回收站自动清理时间", extra: "资产移入回收站后自动彻底删除的天数，0 表示不自动清理。", unit: "天", min: 0, max: 365 },
];
...
const rateFields: PolicyField[] = [
    ...
    { group: "request", name: "assetWritePerMinute", label: "资产写入", extra: "每账号每分钟写入资产的次数。", unit: "次/分钟", max: 999_999 },
