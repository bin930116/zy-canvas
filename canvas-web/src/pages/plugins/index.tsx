...
export default function PluginsPage() {
    ...
    const pluginSections = useMemo(
        () => [
            ...
            { key: "other", label: "应用插件", description: "画布、资产与工作流扩展", icon: PlugZap, plugins: filteredPlugins.filter((plugin) => pluginMatchesCategory(plugin.manifest, "other")) },
        ],
        [filteredPlugins],
    );
                                        ...
                                        <>
                                            <div className="plugin-settings-fields">
                                                ...
                                                <div className="min-w-0">
                                                    ...
                                                    <p>图片、视频和音频生成成功后，自动写入 Eagle；{brandName}本地资产仍会保留。</p>
                                                </div>
                                                <div className="min-w-0">
                                                    <div className="plugin-setting-label-row">
