...
<script setup name="zyAssetCandidateImportModel">
	...
	const customRequestLocal = (data) => {
		...
		return zyAssetCandidateApi
			.zyAssetCandidateImport(fileData)
			.then((res) => {
	...
	const downloadImportTemplate = () => {
		zyAssetCandidateApi.zyAssetCandidateDownloadTemplate().then((res) => {
