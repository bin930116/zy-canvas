...
<script setup name="zyShotRevisionImportModel">
	...
	const customRequestLocal = (data) => {
		...
		return zyShotRevisionApi
			.zyShotRevisionImport(fileData)
			.then((res) => {
	...
	const downloadImportTemplate = () => {
		zyShotRevisionApi.zyShotRevisionDownloadTemplate().then((res) => {
