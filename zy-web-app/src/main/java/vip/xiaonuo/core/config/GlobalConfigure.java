        ...
        return new SaServletFilter()
                ...
                .setBeforeAuth(obj -> {
                    ...
                    SaHolder.getResponse()
                            ...
                            // 允许的header参数（credentials模式下不能用*）
                            .setHeader("Access-Control-Allow-Headers", "token, Authorization, Content-Type, Accept, Origin, X-Requested-With, Cache-Control, Last-Event-ID")
                            // 允许携带凭证
