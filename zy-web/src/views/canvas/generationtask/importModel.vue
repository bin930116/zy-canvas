...
<script setup name="zyGenerationTaskImportModel">
	...
	const customRequestLocal = (data) => {
		...
		return zyGenerationTaskApi
			.zyGenerationTaskImport(fileData)
			.then((res) => {
	...
	const downloadImportTemplate = () => {
		zyGenerationTaskApi.zyGenerationTaskDownloadTemplate().then((res) => {
