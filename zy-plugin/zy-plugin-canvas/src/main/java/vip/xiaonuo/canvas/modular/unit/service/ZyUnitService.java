 ...
 */
package vip.xiaonuo.canvas.modular.unit.service;
...
public interface ZyUnitService extends IService<ZyUnit> {
     ...
     * @date  2026/09/07 18:37
     */
    Page<ZyUnit> page(ZyUnitPageParam zyUnitPageParam);
     ...
     * @date  2026/09/07 18:37
     */
    void add(ZyUnitAddParam zyUnitAddParam);
     ...
     * @date  2026/09/07 18:37
     */
    void edit(ZyUnitEditParam zyUnitEditParam);
     ...
     * @date  2026/09/07 18:37
     */
    void delete(List<ZyUnitIdParam> zyUnitIdParamList);
     ...
     * @date  2026/09/07 18:37
     */
    ZyUnit detail(ZyUnitIdParam zyUnitIdParam);
     ...
     * @date  2026/09/07 18:37
     **/
    ZyUnit queryEntity(Serializable id);
     ...
     * @date  2026/09/07 18:37
     */
    void exportData(List<ZyUnitIdParam> zyUnitIdParamList, HttpServletResponse response) throws IOException;
}
